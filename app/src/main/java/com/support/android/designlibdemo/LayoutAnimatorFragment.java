...
public class LayoutAnimatorFragment extends Fragment implements View.OnClickListener {
    ...
    public void addButton() {
        ...
        LinearLayout.MarginLayoutParams mLayoutParams = new LinearLayout.LayoutParams(200, 200);
        mLayoutParams.setMargins(8,8,8,8);
        mButton.setLayoutParams(mLayoutParams);
        mButton.setTextColor(Color.rgb(0, 0, 0));
        mButton.setBackground(getActivity().getResources().getDrawable(Cheeses.getRandomCheeseDrawable()));
    ...
    public void customLayoutTransition() {
        ...
        ObjectAnimator mObjectAnimatorChangeAppearing = ObjectAnimator.
                ofPropertyValuesHolder(this, pvhLeft, pvhTop, pvhRight, pvhBottom, mHolderScaleX, mHolderScaleY)
